function [x, fx, exitflag, output] = uobyqa_norma(varargin)
%UOBYQA is a solver for solving the following unconstrained continuous
%   optimization problem without using derivatives:
%
%   minimize    fun(x).
%
%   In the backend, UOBYQA calls the late Professor M. J. D. Powell's algorithm
...
%
%   [x, fx, exitflag, output] = uobyqa_norma(INPUTS)
%
...
%       solver: backend solver that does the computation, i.e., 'uobyqa_norma'
