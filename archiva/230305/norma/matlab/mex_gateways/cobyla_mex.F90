...
!   FUNCTION_NAME(funcon, x0, f0, constr0, rhobeg, rhoend, eta1, eta2, gamma1, gamma2, ftarget, ...
!   ctol, cweight, maxfun, iprint, maxhist, output_xhist, output_conhist, maxfilt)
!--------------------------------------------------------------------------------------------------!
