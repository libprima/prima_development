...
if ~isempty(requirements.list)
    ...
    case {'bobyqa', 'bobyqan'}
        ...
        blacklist = [blacklist, {'ARGLINB', 'ARGLINA', 'ARGLINC', 'PENALTY2', 'CHEBYQAD'}];  % Takes too long
    case {'lincoa', 'lincoan'}
        ...
        blacklist = [blacklist, {'DUAL3', 'DUAL2', 'DUAL1', 'HIMMELBI', 'SIM2BQP', 'BQP1VAR', 'LUKSAN22LS','LUKSAN21LS','MINSURF', 'QPCBLEND', 'LSQFIT', 'CVXQP1'}]; % Too long to solve
    case {'cobyla', 'cobylan'}
        ...
        blacklist = [blacklist, {'PRODPL0', 'DEGENLPB', 'ANTWERP', 'SIPOW3', 'AVION2', 'HIMMELBI', 'HS55','PRODPL1', 'BQPGASIM', 'POLAK2', 'ACOPR14', 'PALMER1NE','PALMER8ENE', 'DUALC5'}]; % Takes long to solve
