...
if ~isempty(requirements.list)
    ...
    case {'cobyla', 'cobylan'}
        ...
        blacklist = [blacklist, {'PALMER4ANE', 'PALMER5BNE', 'VESUVIA', 'MESH', 'LOADBAL','MIFFLIN1'}];
        ...
        blacklist = [blacklist, {'PRODPL0', 'DEGENLPB', 'ANTWERP', 'SIPOW3', 'AVION2', 'HIMMELBI', 'HS55','PRODPL1', 'BQPGASIM','LSNNODOC', 'ACOPR14', 'PALMER1NE','PALMER8ENE', 'DUALC5'}]; % Takes long to solve
