...
if ~isempty(requirements.list)
    ...
    case {'bobyqa', 'bobyqan'}
        blacklist = [blacklist, {'PALMER3A', 'HS4', 'PALMER4A'}];  % bobyqaN returns an fx that does not match x; should test it after the modernization.
    ...
    case {'lincoa', 'lincoan'}
        ...
        blacklist = [blacklist, {'DUAL3', 'DUAL2', 'DUAL1', 'SIM2BQP','BQP1VAR', 'LUKSAN22LS','LUKSAN21LS', 'MINSURF', 'QPCBLEND', 'LSQFIT', 'CVXQP1'}]; % Too long to solve
    case {'cobyla', 'cobylan'}
        ...
        blacklist = [blacklist, {'PRODPL0', 'DEGENLPB', 'ANTWERP', 'SIPOW3', 'AVION2', 'ACOPR14', 'PALMER1NE','PALMER8ENE', 'DUALC5'}]; % Takes long to solve
        ...
        'ERRINRSM','ERRINRSMNE', 'FBRAIN3', 'FEEDLOC', 'GROUPING', 'HAIFAM', 'HIMMELBI', 'HYDC20LS', 'HYDCAR20', 'PALMER7ANE', 'KISSING2', ...
