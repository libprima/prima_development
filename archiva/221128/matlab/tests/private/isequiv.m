...
if ~isempty(requirements.list)
    ...
    case {'lincoa', 'lincoan'}
        ...
        % N.B.: Starting from 20230618, we will ignore most of the numerical exceptions in the
        % archiva versions, for which we only verify the faithfulness. Numerical exceptions will
        % (only) be fixed in the modernized version if they happen there.
    ...
    case {'cobyla', 'cobylan'}
        ...
        blacklist = [blacklist, {'PRODPL0', 'DEGENLPB', 'ANTWERP', 'SIPOW3', 'AVION2', 'HIMMELBI', 'HS55','PRODPL1', 'BQPGASIM', 'POLAK2', 'LOADBAL','MIFFLIN1', 'ACOPR14', 'PALMER1NE','PALMER8ENE', 'DUALC5'}]; % Takes long to solve
