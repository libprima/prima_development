...
if ~isempty(requirements.list)
    ...
    case {'lincoa', 'lincoan'}
        ...
        blacklist = [blacklist, {'QPNBOEI2', 'QPCBOEI2', 'DECONVB', 'DECONVU', 'HIMMELBI'}]; % Too long to solve
    ...
    case {'cobyla', 'cobylan'}
        ...
        blacklist = [blacklist, {'PALMER4ANE', 'PALMER5BNE', 'VESUVIA', 'MESH', 'LOADBAL','MIFFLIN1', 'DUALC5'}];
        ...
        blacklist = [blacklist, {'PRODPL0', 'DEGENLPB', 'ANTWERP', 'SIPOW3', 'AVION2', 'HIMMELBI', 'HS55','PRODPL1', 'BQPGASIM','LSNNODOC', 'ACOPR14', 'PALMER1NE','PALMER8ENE'}]; % Takes long to solve
