...
if isempty(requirements.list)
    ...
    case {'cobyla', 'cobylan'}
        ...
        blacklist = [blacklist, {'DEGENLPB', 'LSNNODOC', 'AVION2', 'RES', 'SIPOW3', 'HS55','PRODPL1', 'BQPGASIM', 'LSNNODOC', 'VESUVIA', 'MESH', 'LOADBAL','MIFFLIN1', 'ACOPR14','PALMER1NE','PALMER8ENE', 'DUALC5'}]; % Takes long to solve
