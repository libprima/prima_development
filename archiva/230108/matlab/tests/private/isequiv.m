...
if ~isempty(requirements.list)
    ...
    case {'cobyla_last', 'cobyla'}
        ...
        blacklist = [blacklist, {'PRODPL0', 'PALMER7ANE', 'DEGENLPB', 'ANTWERP', 'SIPOW3', 'AVION2', 'HIMMELBI', 'HS55','PRODPL1', 'BQPGASIM', 'POLAK2', 'LOADBAL','MIFFLIN1', 'ACOPR14', 'PALMER1NE','PALMER8ENE', 'DUALC5'}]; % Takes long to solve
