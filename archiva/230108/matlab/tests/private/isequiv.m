...
if ~isempty(requirements.list)
    ...
    case {'bobyqa_last', 'bobyqa'}
        ...
        blacklist = [blacklist, {'ARGLINB', 'ARGLINA', 'ARGLINC', 'PENALTY2', 'SPIN2LS', 'LUKSAN21LS', 'LUKSAN22LS'}];  % Takes too long
    case {'lincoa_last', 'lincoa'}
        ...
        blacklist = [blacklist, {'DUAL3', 'DUAL2', 'DUAL1', 'HIMMELBI', 'SIM2BQP', 'BQP1VAR', 'LUKSAN22LS','LUKSAN21LS', 'LSQFIT', 'CVXQP1'}]; % Too long to solve
    case {'cobyla_last', 'cobyla'}
        ...
        blacklist = [blacklist, {'PRODPL0', 'PALMER7ANE', 'DEGENLPB', 'ANTWERP', 'SIPOW3', 'AVION2', 'HIMMELBI', 'HS55','PRODPL1', 'BQPGASIM', 'POLAK2', 'LOADBAL','MIFFLIN1', 'ACOPR14', 'PALMER1NE','PALMER8ENE', 'DUALC5', 'DNIEPER'}]; % Takes long to solve
...
test_options.classical = ~(isfield(options, 'no_classical') && options.no_classical) && (rand < 0.05);
